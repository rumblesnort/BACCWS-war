 ...
 * @author rich
 */
@ApplicationPath("/EOS/FirmwareDef")
public class FirmwareDefinitionsConfig extends Application {
    ...
    public Set<Class<?>> getClasses() {
        ...
        try {
            ...
            resources.add(com.Grande.GSM.BACCWS_WAR.WS.REST.EOS.FirmwareDefinitionsEndpoint.class);
        } catch (Exception e) {
